...
namespace Functions
{
    public static class TodoApi
    {
            ...
            ILogger log, string id)
        {
            ...
            if (!string.IsNullOrEmpty(updated.TaskDescription)) existingRow.TaskDescription = updated.TaskDescription;
        ...
        {
            var deleteOperation =
                TableOperation.Delete(new TableEntity {PartitionKey = "TODO", RowKey = id, ETag = "*"});
            try
            {
